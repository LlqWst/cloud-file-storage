window.APP_CONFIG = {
    ...
    githubLink: "https://github.com/LlqWst/cloud-file-storage",
    ...
    * */
    ...
    functions: {
        mapObjectToFrontFormat: (obj) => {
            ...
            const nameWithSlash = isFolder && !obj.name.endsWith('/') ? obj.name + '/' : obj.name;
            const fullPath = (obj.path === '' || obj.path === '/') ?
                nameWithSlash : obj.path + nameWithSlash;
